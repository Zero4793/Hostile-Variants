...
#else
execute if score @s zero.age matches 1200.. at @s if block ~ ~ ~ water run summon drowned ~ ~-2 ~ {Tags:[checked,rotten]}
execute if score @s zero.age matches 1200.. at @s if block ~ ~-1 ~ #sand run summon husk ~ ~-2 ~ {Tags:[checked,rotten]}
execute if score @s zero.age matches 1200.. at @s if block ~ ~-1 ~ netherrack run summon zombified_piglin ~ ~-2 ~ {Tags:[checked,rotten]}
execute if score @s zero.age matches 1200.. at @s unless block ~ ~ ~ water unless block ~ ~-1 ~ #sand unless block ~ ~-1 ~ netherrack run summon zombie ~ ~-2 ~ {Tags:[checked,rotten]}
